...
# set paths
path_data <- '~/Google Drive/My Drive/MGH/Studies/Laurent_Study/data/'
path_code <- '~/Google Drive/My Drive/MGH/Studies/Laurent_Study/code/'
```
...
```{r}
# load data
data <- read.csv(paste0(path_data, 'synthpop2.csv'))
